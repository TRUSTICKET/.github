...
평소 도전해보고 싶었던 분산 시스템 및 대기열 큐 구현을 목적으로 프로젝트 주제를 선정하였습니다.  
...
3. <b>동시성 문제</b> <br>
특정 제한 인원 이상으로 신청되지 않기 위해서 Lock을 사용하였습니다. 해커톤 시간안에 가장 간단하게 해결할 수 있는 방법으로 DB단의 비관적 락을 사용했는데 데드락의 위험성 및 서버 규모를 Scale-out 할 시 적합하지 않을 것이라고 생각했습니다. <br>
따라서 Named Lock 기반으로 동시성 제어 방식을 변경하여 분산 환경에서의 최적화 및 안정성을 증가시켰습니다.  <br><br>
4. <b>캐싱</b> <br>
